...
class ObjectMainDetection {
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/inputvideo.mkv"));
        int count1 = 0, count2 = 0, count3 = 0;
        String o1 = "output/movie_features.txt";
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/ironman.jpg"));
            modelImage2 = ImageUtilities.readMBF(new File("data/captainamerica.jpg"));
            modelImage3 = ImageUtilities.readMBF(new File("data/human.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
